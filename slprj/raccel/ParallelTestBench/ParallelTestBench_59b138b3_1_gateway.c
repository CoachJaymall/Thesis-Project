...
#endif
#include "nesl_rtw.h"
#include "ParallelTestBench_59b138b3_1.h"
#include "ParallelTestBench_59b138b3_1_gateway.h"
void ParallelTestBench_59b138b3_1_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 0 , 0.001 , 0.001 , 0.001 , 0 , 0 , (
NeModifyAbsTol ) 0 , 0.001 , 0 , 0 , 0 , 0 , ( SscLoggingSetting ) 0 ,
637713896 , 1 , 0 , 0 , } ; NeSolverParameters solverparams = { 0 , 0 , 1 , 0
...
sizeof ( outputparameters_init [ 0 ] ) ; } ParallelTestBench_59b138b3_1_dae (
& dae , & modelparams , & solverparams ) ; nesl_register_simulator_group (
"ParallelTestBench/ICE Side Inertias/Solver Configuration_1" , 1 , & dae , &
