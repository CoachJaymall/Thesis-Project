...
) , TARGET_STRING ( "" ) , 0 , 0 , 3 , 0 , 0 } , { 82 , 0 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 1 , 0 , 0 , 0 , 2 } , { 89 , 0 , TARGET_STRING (
...
) , TARGET_STRING ( "EngTrq" ) , 0 , 0 , 0 , 0 , 0 } , { 108 , 0 ,
TARGET_STRING (
 ...
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/Motor Units1/Gain"
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 129 , 13 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 130 , 13 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 131 , 14 , TARGET_STRING (
...
"ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/High Torque/Add"
 ...
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/PMSM Electromagnetic/Inverse Clarke Transform/Subtract2"
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 166 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 167 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 168 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 179 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 1 } , { 180 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 1 } , { 181 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 182 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 183 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 184 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 185 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 186 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 203 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 204 , 12 , TARGET_STRING (
...
) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 205 , 11 , TARGET_STRING (
...
rtBlockParameters [ ] = { { 206 , TARGET_STRING (
"ParallelTestBench/Datasheet Battery" ) , TARGET_STRING ( "Em" ) , 0 , 6 , 0
} , { 207 , TARGET_STRING ( "ParallelTestBench/Datasheet Battery" ) ,
TARGET_STRING ( "CapLUTBp" ) , 0 , 6 , 0 } , { 208 , TARGET_STRING (
"ParallelTestBench/Datasheet Battery" ) , TARGET_STRING ( "RInt" ) , 0 , 7 ,
0 } , { 209 , TARGET_STRING ( "ParallelTestBench/Datasheet Battery" ) ,
TARGET_STRING ( "BattTempBp" ) , 0 , 8 , 0 } , { 210 , TARGET_STRING (
"ParallelTestBench/Datasheet Battery" ) , TARGET_STRING ( "CapSOCBp" ) , 0 ,
9 , 0 } , { 211 , TARGET_STRING ( "ParallelTestBench/Datasheet Battery" ) ,
TARGET_STRING ( "Tc" ) , 0 , 0 , 0 } , { 212 , TARGET_STRING (
"ParallelTestBench/Datasheet Battery" ) , TARGET_STRING ( "Vinit" ) , 0 , 0 ,
0 } , { 213 , TARGET_STRING ( "ParallelTestBench/SKP 6485" ) , TARGET_STRING
( "idq0" ) , 0 , 10 , 0 } , { 214 , TARGET_STRING (
"ParallelTestBench/SKP 6485" ) , TARGET_STRING ( "theta_init" ) , 0 , 0 , 0 }
, { 215 , TARGET_STRING ( "ParallelTestBench/SKP 6485" ) , TARGET_STRING (
"omega_init" ) , 0 , 0 , 0 } , { 216 , TARGET_STRING (
"ParallelTestBench/Surface Mount PM Controller1" ) , TARGET_STRING (
"idq_limits" ) , 0 , 0 , 0 } , { 217 , TARGET_STRING (
"ParallelTestBench/Surface Mount PM Controller1" ) , TARGET_STRING ( "Kp_d" )
, 0 , 0 , 0 } , { 218 , TARGET_STRING (
...
0 , 0 , 0 } , { 227 , TARGET_STRING ( "ParallelTestBench/Constant" ) ,
TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 228 , TARGET_STRING (
"ParallelTestBench/Constant1" ) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , {
229 , TARGET_STRING ( "ParallelTestBench/Constant2" ) , TARGET_STRING (
"Value" ) , 0 , 0 , 0 } , { 230 , TARGET_STRING (
"ParallelTestBench/Constant3" ) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , {
231 , TARGET_STRING ( "ParallelTestBench/Constant4" ) , TARGET_STRING (
"Value" ) , 0 , 0 , 0 } , { 232 , TARGET_STRING ( "ParallelTestBench/Gain1" )
, TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 233 , TARGET_STRING (
"ParallelTestBench/kg//s to g//min" ) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0
} , { 234 , TARGET_STRING ( "ParallelTestBench/Integrator" ) , TARGET_STRING
( "InitialCondition" ) , 0 , 0 , 0 } , { 235 , TARGET_STRING (
"ParallelTestBench/DA50 Power Map" ) , TARGET_STRING ( "Table" ) , 0 , 11 , 0
} , { 236 , TARGET_STRING ( "ParallelTestBench/DA50 Power Map" ) ,
TARGET_STRING ( "BreakpointsForDimension1" ) , 0 , 12 , 0 } , { 237 ,
TARGET_STRING ( "ParallelTestBench/DA50 Power Map" ) , TARGET_STRING (
"BreakpointsForDimension2" ) , 0 , 13 , 0 } , { 238 , TARGET_STRING (
"ParallelTestBench/DA50 Power Map" ) , TARGET_STRING ( "maxIndex" ) , 2 , 2 ,
0 } , { 239 , TARGET_STRING ( "ParallelTestBench/DA50 Torque Map" ) ,
TARGET_STRING ( "Table" ) , 0 , 11 , 0 } , { 240 , TARGET_STRING (
"ParallelTestBench/DA50 Torque Map" ) , TARGET_STRING (
"BreakpointsForDimension1" ) , 0 , 12 , 0 } , { 241 , TARGET_STRING (
"ParallelTestBench/DA50 Torque Map" ) , TARGET_STRING (
"BreakpointsForDimension2" ) , 0 , 13 , 0 } , { 242 , TARGET_STRING (
"ParallelTestBench/DA50 Torque Map" ) , TARGET_STRING ( "maxIndex" ) , 2 , 2
, 0 } , { 243 , TARGET_STRING ( "ParallelTestBench/Step" ) , TARGET_STRING (
"Time" ) , 0 , 0 , 0 } , { 244 , TARGET_STRING ( "ParallelTestBench/Step" ) ,
TARGET_STRING ( "Before" ) , 0 , 0 , 0 } , { 245 , TARGET_STRING (
"ParallelTestBench/Step" ) , TARGET_STRING ( "After" ) , 0 , 0 , 0 } , { 246
, TARGET_STRING ( "ParallelTestBench/Manual Switch" ) , TARGET_STRING (
"CurrentSetting" ) , 1 , 0 , 0 } , { 247 , TARGET_STRING (
"ParallelTestBench/Manual Switch1" ) , TARGET_STRING ( "CurrentSetting" ) , 1
, 0 , 0 } , { 248 , TARGET_STRING ( "ParallelTestBench/Manual Switch2" ) ,
TARGET_STRING ( "CurrentSetting" ) , 1 , 0 , 0 } , { 249 , TARGET_STRING (
"ParallelTestBench/Manual Switch3" ) , TARGET_STRING ( "CurrentSetting" ) , 1
, 0 , 0 } , { 250 , TARGET_STRING (
"ParallelTestBench/BLDC Speed/fromWS_Signal 1" ) , TARGET_STRING ( "Time0" )
, 0 , 14 , 0 } , { 251 , TARGET_STRING (
"ParallelTestBench/BLDC Speed/fromWS_Signal 1" ) , TARGET_STRING ( "Data0" )
, 0 , 14 , 0 } , { 252 , TARGET_STRING ( "ParallelTestBench/Clutch/Merge" ) ,
TARGET_STRING ( "InitialOutput" ) , 0 , 0 , 0 } , { 253 , TARGET_STRING (
"ParallelTestBench/Clutch/Merge1" ) , TARGET_STRING ( "InitialOutput" ) , 0 ,
0 , 0 } , { 254 , TARGET_STRING ( "ParallelTestBench/Clutch/Merge2" ) ,
TARGET_STRING ( "InitialOutput" ) , 0 , 0 , 0 } , { 255 , TARGET_STRING (
...
TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 266 , TARGET_STRING (
"ParallelTestBench/Corvid-50/Engine Crank Angle Calculation/Integrator" ) ,
TARGET_STRING ( "WrappedStateUpperValue" ) , 0 , 0 , 0 } , { 267 ,
TARGET_STRING (
"ParallelTestBench/Corvid-50/Engine Crank Angle Calculation/Integrator" ) ,
TARGET_STRING ( "WrappedStateLowerValue" ) , 0 , 0 , 0 } , { 268 ,
TARGET_STRING (
"ParallelTestBench/Corvid-50/Mapped Engine Power Info/rpm to rad//s" ) ,
TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 269 , TARGET_STRING (
"ParallelTestBench/Subsystem/Clutch Engaged/Merge" ) , TARGET_STRING (
"InitialOutput" ) , 0 , 0 , 0 } , { 270 , TARGET_STRING (
"ParallelTestBench/Subsystem/Clutch Engaged/Merge1" ) , TARGET_STRING (
"InitialOutput" ) , 0 , 0 , 0 } , { 271 , TARGET_STRING (
...
, TARGET_STRING ( "BreakpointsForDimension1" ) , 0 , 12 , 0 } , { 273 ,
TARGET_STRING (
"ParallelTestBench/Throttle Selector/If Action Subsystem/1-D Lookup Table" )
, TARGET_STRING ( "BreakpointsForDimension2" ) , 0 , 9 , 0 } , { 274 ,
TARGET_STRING (
"ParallelTestBench/Throttle Selector/If Action Subsystem/1-D Lookup Table" )
, TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 275 , TARGET_STRING (
"ParallelTestBench/Throttle Selector/If Action Subsystem/1-D Lookup Table1" )
, TARGET_STRING ( "Table" ) , 0 , 12 , 0 } , { 276 , TARGET_STRING (
"ParallelTestBench/Throttle Selector/If Action Subsystem/Switch" ) ,
...
) , TARGET_STRING ( "Table" ) , 0 , 18 , 0 } , { 281 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/No Dyno Load/1-D Lookup Table2"
) , TARGET_STRING ( "BreakpointsForDimension1" ) , 0 , 19 , 0 } , { 282 ,
TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/No Dyno Load/1-D Lookup Table2"
) , TARGET_STRING ( "BreakpointsForDimension2" ) , 0 , 9 , 0 } , { 283 ,
TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/No Dyno Load/1-D Lookup Table2"
) , TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 284 , TARGET_STRING (
...
TARGET_STRING (
 ...
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/Mechanical and Angle/Int"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 295 ,
TARGET_STRING (
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/Mechanical and Angle/Int"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 296 ,
TARGET_STRING (
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/Mechanical and Angle/Int1"
) , TARGET_STRING ( "WrappedStateUpperValue" ) , 0 , 0 , 0 } , { 297 ,
TARGET_STRING (
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/Mechanical and Angle/Int1"
) , TARGET_STRING ( "WrappedStateLowerValue" ) , 0 , 0 , 0 } , { 298 ,
TARGET_STRING (
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/Motor Units1/Gain"
) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 299 , TARGET_STRING (
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/Motion control/Discrete-Time Integrator"
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 300 , TARGET_STRING (
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/Motion control/Discrete-Time Integrator"
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 301 ,
TARGET_STRING (
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/Motion control/Discrete-Time Integrator1"
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 302 , TARGET_STRING (
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/Motion control/Discrete-Time Integrator1"
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 303 ,
TARGET_STRING (
...
) , TARGET_STRING ( "gainval" ) , 0 , 0 , 0 } , { 304 , TARGET_STRING (
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/State Filter/Discrete-Time Integrator"
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 305 ,
TARGET_STRING (
...
) , TARGET_STRING ( "Value" ) , 0 , 5 , 0 } , { 307 , TARGET_STRING (
...
) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 309 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/Fuel Efficient/1-D Lookup Table"
) , TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 310 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/Fuel Efficient/1-D Lookup Table2"
) , TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 311 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/Fuel Efficient/Switch1"
) , TARGET_STRING ( "Threshold" ) , 0 , 0 , 0 } , { 312 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/Fuel Efficient/Switch2"
) , TARGET_STRING ( "Threshold" ) , 0 , 0 , 0 } , { 313 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/Fuel Efficient/Switch3"
) , TARGET_STRING ( "Threshold" ) , 1 , 0 , 0 } , { 314 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/High Torque/1-D Lookup Table2"
) , TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 315 , TARGET_STRING (
 ...
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/Low Torque/Switch1"
) , TARGET_STRING ( "Threshold" ) , 0 , 0 , 0 } , { 317 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Both Spinning/Dyno Loaded/Low Torque/Switch4"
) , TARGET_STRING ( "Threshold" ) , 0 , 0 , 0 } , { 318 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Either Spinning/Only ICE/Fuel Efficient/Constant2"
) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 319 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Either Spinning/Only ICE/Fuel Efficient/Constant3"
) , TARGET_STRING ( "Value" ) , 0 , 5 , 0 } , { 320 , TARGET_STRING (
...
) , TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 323 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Either Spinning/Only ICE/Fuel Efficient/1-D Lookup Table2"
) , TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 324 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Either Spinning/Only ICE/Fuel Efficient/Switch1"
) , TARGET_STRING ( "Threshold" ) , 0 , 0 , 0 } , { 325 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Either Spinning/Only ICE/Fuel Efficient/Switch2"
) , TARGET_STRING ( "Threshold" ) , 0 , 0 , 0 } , { 326 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Either Spinning/Only ICE/Fuel Efficient/Switch3"
) , TARGET_STRING ( "Threshold" ) , 1 , 0 , 0 } , { 327 , TARGET_STRING (
 "ParallelTestBench/Torque Split Logic/Either Spinning/Only ICE/High Torque/1-D Lookup Table2"
) , TARGET_STRING ( "maxIndex" ) , 2 , 2 , 0 } , { 328 , TARGET_STRING (
...
) , TARGET_STRING ( "Gain" ) , 0 , 0 , 0 } , { 333 , TARGET_STRING (
 ...
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/Current Controller External/Current_Generation/Merge1"
) , TARGET_STRING ( "InitialOutput" ) , 0 , 0 , 0 } , { 346 , TARGET_STRING (
...
) , TARGET_STRING ( "Value" ) , 0 , 10 , 0 } , { 353 , TARGET_STRING (
 ...
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/PMSM Electromagnetic/PMSM Equivalent Circuit/D Axis Stator Voltage/Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 357 ,
TARGET_STRING (
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/PMSM Electromagnetic/PMSM Equivalent Circuit/D Axis Stator Voltage/Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 358 ,
TARGET_STRING (
 ...
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/PMSM Electromagnetic/PMSM Equivalent Circuit/Q Axis Stator Voltage/Integrator"
) , TARGET_STRING ( "UpperSaturationLimit" ) , 0 , 0 , 0 } , { 360 ,
TARGET_STRING (
 "ParallelTestBench/SKP 6485/PMSM Torque Input Exterior Continuous/PMSM Torque Input Core/PMSM Electromagnetic/PMSM Equivalent Circuit/Q Axis Stator Voltage/Integrator"
) , TARGET_STRING ( "LowerSaturationLimit" ) , 0 , 0 , 0 } , { 361 ,
TARGET_STRING (
...
) , TARGET_STRING ( "InitialCondition" ) , 0 , 0 , 0 } , { 367 ,
TARGET_STRING (
 ...
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/Current Controller External/DQ Current Control and Decouple/Integrator1/Saturation"
) , TARGET_STRING ( "UpperLimit" ) , 0 , 0 , 0 } , { 369 , TARGET_STRING (
 "ParallelTestBench/Surface Mount PM Controller1/Exterior PMSM Speed Control Drive CE/PMSM Speed Control Exterior/Current Controller External/DQ Current Control and Decouple/Integrator1/Saturation"
) , TARGET_STRING ( "LowerLimit" ) , 0 , 0 , 0 } , { 370 , TARGET_STRING (
...
) , TARGET_STRING ( "Value" ) , 0 , 10 , 0 } , { 372 , TARGET_STRING (
...
) , TARGET_STRING ( "Value" ) , 0 , 10 , 0 } , { 374 , TARGET_STRING (
...
) , TARGET_STRING ( "Value" ) , 0 , 10 , 0 } , { 377 , TARGET_STRING (
...
) , TARGET_STRING ( "Value" ) , 0 , 0 , 0 } , { 388 , TARGET_STRING (
...
rtwCAPI_ModelParameters rtModelParameters [ ] = { { 390 , TARGET_STRING (
"Batt_Cap" ) , 0 , 0 , 0 } , { 391 , TARGET_STRING ( "Batt_Parr" ) , 0 , 0 ,
0 } , { 392 , TARGET_STRING ( "Batt_Series" ) , 0 , 0 , 0 } , { 393 ,
TARGET_STRING ( "Dyno_Ke" ) , 0 , 0 , 0 } , { 394 , TARGET_STRING ( "Dyno_Kt"
) , 0 , 0 , 0 } , { 395 , TARGET_STRING ( "Dyno_Ratio" ) , 0 , 0 , 0 } , {
396 , TARGET_STRING ( "Fuel_Map" ) , 0 , 20 , 0 } , { 397 , TARGET_STRING (
"Fuel_MapE" ) , 0 , 20 , 0 } , { 398 , TARGET_STRING ( "Power_Map" ) , 0 , 20
, 0 } , { 399 , TARGET_STRING ( "Power_Thr_Map" ) , 0 , 11 , 0 } , { 400 ,
TARGET_STRING ( "SideA_N" ) , 0 , 0 , 0 } , { 401 , TARGET_STRING (
"SideA_Physical_Param" ) , 0 , 21 , 0 } , { 402 , TARGET_STRING (
"SideA_RatedTrq" ) , 0 , 0 , 0 } , { 403 , TARGET_STRING ( "SideA_Rs" ) , 0 ,
0 , 0 } , { 404 , TARGET_STRING ( "SideA_lambda" ) , 0 , 0 , 0 } , { 405 ,
TARGET_STRING ( "Spd_BP" ) , 0 , 8 , 0 } , { 406 , TARGET_STRING ( "Trq_BP" )
, 0 , 22 , 0 } , { 0 , ( NULL ) , 0 , 0 , 0 } } ;
...
fdtuj3yfv3 , & rtB . ctnwpqizmx , & rtB . eqqz4ci0tv , & rtB . eqqz4ci0tv , &
rtB . eqqz4ci0tv , & rtB . obpp1l4vac , & rtB . eqqz4ci0tv , & rtB .
obpp1l4vac , & rtB . eqqz4ci0tv , & rtB . eqqz4ci0tv , & rtB . obpp1l4vac , &
rtB . mxgpxbyfng [ 0 ] , & rtB . m12o31k1vs [ 0 ] , & rtB . kyvpkfkfuw [ 0 ]
, & rtB . jhai0ek5up [ 0 ] , & rtB . ea1x0lvxve , & rtB . nwoetve5i4 [ 0 ] ,
& rtB . j14q1l0ljs [ 0 ] , & rtB . jhwxdwr1el , & rtB . itamdryrgl , & rtB .
gg2bbcdrrw , & rtB . g1be22q2ab [ 0 ] , & rtB . a51hahehmm [ 0 ] , & rtB .
akjx0hsfge [ 0 ] , & rtB . ctnwpqizmx , & rtB . eqqz4ci0tv , & rtB .
ctnwpqizmx , & rtB . eqqz4ci0tv , & rtB . ctnwpqizmx , & rtB . eqqz4ci0tv , &
rtB . eqqz4ci0tv , & rtB . obpp1l4vac , & rtB . eqqz4ci0tv , & rtB .
eqqz4ci0tv , & rtB . eqqz4ci0tv , & rtB . m4c5zvfilf [ 0 ] , & rtB .
otltqoc5al , & rtB . ev0c2l5p3p , & rtB . hg3boogiog , & rtB . k2emjlyzxk , &
rtB . chctnrcvr3 , & rtB . kvxxl1simd , & rtB . max0cti2zd , & rtB .
fcdzod43fw , & rtB . aarbwzwmur , & rtB . d44xfr2uxh , & rtB . ksa4mls0wk , &
rtB . fkufe2dwcc , & rtB . lh5ejoytai , & rtB . prxcefcei5 , & rtB .
baetrfr4r5 , & rtB . i4tiig10qa , & rtB . ii512bfhkj , & rtB . ct0fhunmet , &
rtB . ludaotrnqc , & rtB . fyijl5q30k , & rtB . gvb04ezgus , & rtB .
k2zygd0izr , & rtB . em2j1rtzfx , & rtB . m4hxih4mk4 , & rtB . dwin0lk10m , &
rtB . gssztf5fdg , & rtB . m5zlrndttj , & rtB . gg2bbcdrrw , & rtB .
lthpnqg4ps , & rtB . n3yzlaao40 , & rtB . pomgrq4ofk , & rtB . oudpsgugrl , &
rtB . ennxpj0tru [ 0 ] , & rtB . m4bwkc5hnn , & rtB . frdjc0ipbc , & rtB .
o1uhppc0j4 , & rtB . ctnwpqizmx , & rtB . eqqz4ci0tv , & rtB . ctnwpqizmx , &
rtB . ml5chi14gx , & rtB . bykovcr4gn , & rtB . kt4qdvgqqh , & rtB .
fjud52gekg [ 0 ] , & rtB . favitckluv , & rtB . lo0fmxamwn , & rtB .
eqqz4ci0tv , & rtB . eqqz4ci0tv , & rtB . bvlzron2lo , & rtB . bdpeazbcik , &
rtB . nfsnsrxlvr , ( & rtB . j14q1l0ljs [ 0 ] + 2 ) , & rtB . ht0sdc4e2n , &
rtB . krguxydvse , & rtB . ivjcnxt5l0 , & rtB . fpnl3wyn4z , & rtB .
lufxmyxbr0 , & rtB . lg5bmspaoy , & rtB . mi1n1xzbri , & rtB . ddcgg2bx0n , &
rtB . dbu1cph3qd , & rtB . ph0oqajh3o , & rtB . gx1mbhkzzf , & rtB .
hzgfvz42dk , & rtB . hzgfvz42dk , & rtB . hzgfvz42dk , & rtB . krukbv1au2 , &
...
Gain_Gain_bcxpylev1y , & rtP . DiscreteTimeIntegrator_gainval , & rtP .
DiscreteTimeIntegrator_IC , & rtP . DiscreteTimeIntegrator1_gainval , & rtP .
DiscreteTimeIntegrator1_IC , & rtP .
...
rtwCAPI_MATRIX_COL_MAJOR , 36 , 2 , 0 } , { rtwCAPI_VECTOR , 38 , 2 , 0 } , {
rtwCAPI_MATRIX_COL_MAJOR , 40 , 2 , 0 } , { rtwCAPI_VECTOR , 42 , 2 , 0 } , {
rtwCAPI_VECTOR , 44 , 2 , 0 } } ; static const uint_T rtDimensionArray [ ] =
{ 1 , 1 , 4 , 1 , 2 , 1 , 5 , 1 , 3 , 1 , 12 , 1 , 1 , 101 , 7 , 6 , 1 , 7 ,
1 , 6 , 1 , 2 , 11 , 6 , 1 , 11 , 6 , 1 , 10 , 1 , 13 , 1 , 8 , 1 , 11 , 1 ,
10 , 6 , 1 , 10 , 12 , 7 , 1 , 3 , 1 , 12 } ; static const real_T
rtcapiStoredFloats [ ] = { 0.0 , 5.0E-5 } ; static const rtwCAPI_FixPtMap
...
static rtwCAPI_ModelMappingStaticInfo mmiStatic = { { rtBlockSignals , 206 ,
rtRootInputs , 0 , rtRootOutputs , 0 } , { rtBlockParameters , 184 ,
rtModelParameters , 17 } , { ( NULL ) , 0 } , { rtDataTypeMap ,
rtDimensionMap , rtFixPtMap , rtElementMap , rtSampleTimeMap ,
rtDimensionArray } , "float" , { 2006713274U , 243113040U , 2648925310U ,
2781112266U } , ( NULL ) , 0 , ( boolean_T ) 0 , rt_LoggedStateIdxList } ;
