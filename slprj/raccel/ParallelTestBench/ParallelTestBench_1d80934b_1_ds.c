#include "ne_ds.h"
#include "ParallelTestBench_1d80934b_1_ds_obs_il.h"
#include "ParallelTestBench_1d80934b_1_ds_obs_all.h"
#include "ParallelTestBench_1d80934b_1_ds_obs_act.h"
#include "ParallelTestBench_1d80934b_1_ds_obs_exp.h"
...
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , 2U , 0U , TRUE , 1.0 ,
"1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , 2U , 2U , TRUE , 1.0 ,
"1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , 2U , 4U , TRUE , 1.0 ,
"1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , 1U ,
6U , TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"ParallelTestBench/BLDC Side Inertias/Ideal Angular Velocity Source" , 1U ,
7U , TRUE , 1.0 , "1" , } } ; static NeCERData * s_cer_data = NULL ; static
NeICRData * s_icr_data = NULL ; static NeVariableData s_variable_data [ 5 ] =
{ { "BLDC_Side_Inertias.BLDC_Shaft.phi" , 0U , 0 ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , 1.0 , "1" , 0.0 , TRUE ,
FALSE , { { 1 , 1 } } , NE_INIT_MODE_NONE , "phi" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_inertia.w" , 0U , 0 ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , 1.0 , "1" , 0.0 , TRUE ,
FALSE , { { 1 , 1 } } , NE_INIT_MODE_NONE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.phi" , 0U , 0 ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , 1.0 , "1" , 0.0 , TRUE
, FALSE , { { 1 , 1 } } , NE_INIT_MODE_NONE , "phi" , } , {
"BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor.phi" , 0U , 0 ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , 1.0 ,
"1" , 0.0 , TRUE , FALSE , { { 1 , 1 } } , NE_INIT_MODE_MANDATORY , "Angle" ,
} , { "BLDC_Side_Inertias.Clutch_Rotor.torsional_inertia.t" , 0U , 0 ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , 1.0 , "1" , 0.0 , FALSE
, FALSE , { { 1 , 1 } } , NE_INIT_MODE_NONE , "Torque" , } } ; static
NeVariableData * s_discrete_data = NULL ; static NeObservableData
s_observable_data [ 56 ] = { { "BLDC_Side_Inertias.BLDC_Shaft.B.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.F.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.Fsupports" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 4 } } , "N" , 1.0
, "N" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Fr" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.Msupports" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 4 } } , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "M" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.Vsupports" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 4 } } , "m/s" ,
1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "V" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.Wsupports" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 4 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "W" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.phi" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad" ,
1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , TRUE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "phi" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_damper.C.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_damper.R.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_damper.t" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_damper.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_damper.power_dissipated" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } ,
"kg*m^2/s^3" , 1.0 , "kg*m^2/s^3" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , FALSE ,
"power_dissipated" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_inertia.I.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_inertia.J.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_inertia.t" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.torsional_inertia.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , TRUE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.w" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , TRUE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "w" , } , {
"BLDC_Side_Inertias.BLDC_Shaft.wDer" ,
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , { { 1 , 1 } } , "rad/s^2"
, 1.0 , "1/s^2" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "wDer" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.B.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.F.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.Fsupports" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 4 } } , "N" ,
1.0 , "N" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Fr" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.Msupports" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 4 } } , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "M" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.Vsupports" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 4 } } , "m/s" ,
1.0 , "m/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "V" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.Wsupports" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 4 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "W" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.phi" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad" ,
1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , TRUE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "phi" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_damper.C.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_damper.R.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_damper.t" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_damper.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_damper.power_dissipated" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } ,
"kg*m^2/s^3" , 1.0 , "kg*m^2/s^3" , NE_NOMINAL_SOURCE_NONE ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , FALSE ,
"power_dissipated" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_inertia.I.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_inertia.J.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_inertia.t" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.torsional_inertia.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , TRUE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.w" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } , "rad/s"
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , TRUE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "w" , } , {
"BLDC_Side_Inertias.Clutch_Rotor.wDer" ,
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , { { 1 , 1 } } ,
"rad/s^2" , 1.0 , "1/s^2" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "wDer" , } , {
"BLDC_Side_Inertias.Ideal_Angular_Velocity_Source.C.w" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Angular Velocity Source" , { { 1
, 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"BLDC_Side_Inertias.Ideal_Angular_Velocity_Source.R.w" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Angular Velocity Source" , { { 1
, 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"BLDC_Side_Inertias.Ideal_Angular_Velocity_Source.S" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Angular Velocity Source" , { { 1
, 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "S"
, } , { "BLDC_Side_Inertias.Ideal_Angular_Velocity_Source.t" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Angular Velocity Source" , { { 1
, 1 } } , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"BLDC_Side_Inertias.Ideal_Angular_Velocity_Source.w" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Angular Velocity Source" , { { 1
, 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angular velocity" , } , {
"BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor.A" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , { { 1
, 1 } } , "rad" , 1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "A" , } , {
"BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor.C.w" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , { { 1
, 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Rotational velocity" , } , {
"BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor.R.w" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , { { 1
, 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , {
"BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor.W" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , { { 1
, 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "W"
, } , { "BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor.alpha" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , { { 1
, 1 } } , "rad/s^2" , 1.0 , "1/s^2" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"\316\261" , } , { "BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor.phi" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Rotational Motion Sensor" , { { 1
, 1 } } , "rad" , 1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_MANDATORY , FALSE , TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Angle" , } , { "BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor_W0" ,
"ParallelTestBench/BLDC Side Inertias/PS-Simulink\nConverter" , { { 1 , 1 } }
...
"BLDC_Side_Inertias.Ideal_Torque_Sensor.C.w" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Torque Sensor" , { { 1 , 1 } } ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Ideal_Torque_Sensor.R.w" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Torque Sensor" , { { 1 , 1 } } ,
"rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"BLDC_Side_Inertias.Ideal_Torque_Sensor.T" ,
"ParallelTestBench/BLDC Side Inertias/Ideal Torque Sensor" , { { 1 , 1 } } ,
...
"BLDC_Side_Inertias.Ideal_Torque_Sensor_T0" ,
"ParallelTestBench/BLDC Side Inertias/PS-Simulink\nConverter1" , { { 1 , 1 }
} , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE
, FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Ideal_Torque_Sensor_T0" , }
, { "BLDC_Side_Inertias.Mechanical_Rotational_Reference.W.w" ,
"ParallelTestBench/BLDC Side Inertias/Mechanical Rotational Reference" , { {
1 , 1 } } , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , { "BLDC_Side_Inertias.PS_Terminator.I" ,
"ParallelTestBench/BLDC Side Inertias/PS Terminator" , { { 1 , 1 } } , "rad"
, 1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "I" , } , {
"BLDC_Side_Inertias.Simulink_PS_Converter2_output0" ,
"ParallelTestBench/BLDC Side Inertias/Simulink-PS\nConverter2" , { { 1 , 1 }
} , "rad/s" , 1.0 , "rad/s" , NE_NOMINAL_SOURCE_FIXED , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Simulink_PS_Converter2_output0" , } } ; static NeModeData *
s_major_mode_data = NULL ; static NeZCData * s_zc_data = NULL ; static
NeRange * s_range = NULL ; static NeAssertData s_assert_data [ 4 ] = { {
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , 1U , 0U ,
"BLDC_Side_Inertias.BLDC_Shaft.torsional_damper.power_dissipated" ,
...
"ParallelTestBench/BLDC Side Inertias/BLDC Shaft" , 1U , 1U ,
"BLDC_Side_Inertias.BLDC_Shaft.torsional_damper.power_dissipated" ,
 "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/damper.ssc"
, FALSE ,
...
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , 1U , 2U ,
"BLDC_Side_Inertias.Clutch_Rotor.torsional_damper.power_dissipated" ,
 "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/damper.ssc"
, FALSE ,
"In power, the exponent must be positive when the base is equal to zero." ,
"physmod:common:mf:expr:analyze:RequireExponentPositive" , } , {
"ParallelTestBench/BLDC Side Inertias/Clutch Rotor" , 1U , 3U ,
"BLDC_Side_Inertias.Clutch_Rotor.torsional_damper.power_dissipated" ,
 "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/damper.ssc"
, FALSE ,
"In power, the base must be nonnegative when the exponent is not an integer."
, "physmod:common:mf:expr:analyze:RequireBaseNonnegative" , } } ; static
NeRange s_assert_range [ 4 ] = { {
 "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/damper.ssc"
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mLOG . mN = 42 ; out
-> mLOG . mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof (
real_T ) , 42 ) ; return out ; } static NeDsMethodOutput * ds_output_assert (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mASSERT . mN = 4 ; out
-> mASSERT . mX = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof
( int32_T ) , 4 ) ; return out ; } static NeDsMethodOutput *
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_EXP . mN = 78 ;
out -> mOBS_EXP . mX = ( real_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( real_T ) , 78 ) ; return out ; } static NeDsMethodOutput *
ds_output_obs_act ( const NeDynamicSystem * ds , PmAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
mOBS_ACT . mN = 78 ; out -> mOBS_ACT . mX = ( real_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( real_T ) , 78 ) ; return out ; } static
NeDsMethodOutput * ds_output_obs_all ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mOBS_ALL . mN = 78 ; out -> mOBS_ALL . mX =
( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 78 ) ;
return out ; } static NeDsMethodOutput * ds_output_obs_il ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_IL . mN = 78 ; out ->
mOBS_IL . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof (
boolean_T ) , 78 ) ; return out ; } static NeDsMethodOutput * ds_output_dp_l
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
NeDynamicSystem * ParallelTestBench_1d80934b_1_dae_ds ( PmAllocator *
...
mNumDiscreteRealVariables = 0 ; ds -> mNumDifferentialVariables = 4 ; ds ->
mNumEquations = 5 ; ds -> mNumCEResiduals = 0 ; ds -> mNumICResiduals = 0 ;
ds -> mNumFreqs = 0 ; ds -> mNumSolverHits = 0 ; ds -> mNumModes = 0 ; ds ->
mNumMajorModes = 0 ; ds -> mNumRealCache = 0 ; ds -> mNumIntCache = 0 ; ds ->
mNumObservables = 56 ; ds -> mNumObservableElements = 78 ; ds -> mNumZcs = 0
; ds -> mNumAsserts = 4 ; ds -> mNumAssertRanges = 4 ; ds -> mNumParamAsserts
...
] . mIdentifier = "BLDC_Side_Inertias.Simulink_PS_Converter2_output0" ;
...
0 ] . mName = "BLDC_Side_Inertias.Simulink_PS_Converter2_output0" ;
input_info [ 0 ] . mUnit = "rad/s" ; ds -> mIo [ SSC_INPUT_IO_TYPE ] =
input_info ; ds -> mNumIo [ SSC_OUTPUT_IO_TYPE ] = 2 ; output_info [ 0 ] .
mIdentifier = "BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor_W0" ;
...
[ 0 ] . mName = "BLDC_Side_Inertias.Ideal_Rotational_Motion_Sensor_W0" ;
output_info [ 0 ] . mUnit = "rad/s" ; output_info [ 1 ] . mIdentifier =
"BLDC_Side_Inertias.Ideal_Torque_Sensor_T0" ; output_info [ 1 ] . mSize =
...
"BLDC_Side_Inertias.Ideal_Torque_Sensor_T0" ; output_info [ 1 ] . mUnit =
"N*m" ; ds -> mIo [ SSC_OUTPUT_IO_TYPE ] = output_info ; ds ->
...
NE_DS_METHOD_LOG ] = ParallelTestBench_1d80934b_1_ds_log ; ds -> mMakeOutput
...
ParallelTestBench_1d80934b_1_ds_obs_exp ; ds -> mMakeOutput [
NE_DS_METHOD_OBS_EXP ] = ds_output_obs_exp ; ds -> mMethods [
NE_DS_METHOD_OBS_ACT ] = ParallelTestBench_1d80934b_1_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = ParallelTestBench_1d80934b_1_ds_obs_all ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds -> mMethods [
NE_DS_METHOD_OBS_IL ] = ParallelTestBench_1d80934b_1_ds_obs_il ; ds ->
...
] = 1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_passert (
...
( void ) t1 ; out = t2 -> mDXCER_P ; out . mNumCol = 5ULL ; out . mNumRow =
...
; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_ddcer_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
...
mDXDELT_P ; out . mNumCol = 5ULL ; out . mNumRow = 0ULL ; out . mJc [ 0 ] = 0
...
out . mX [ 3 ] = - 0.0 ; out . mX [ 4 ] = - 0.0 ; ( void ) sys ; ( void ) t2
; return 0 ; } static int32_T ds_dxf ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void )
sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dxf_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mDXF_P ; out .
mNumCol = 5ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
...
5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2
...
mNumCol = 1ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
= 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_ddf ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_ddf_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDDF_P ; out . mNumCol = 0ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ;
( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_a ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t3 , NeDsMethodOutput *
t4 ) { PmRealVector out ; real_T t0 [ 5 ] ; real_T t1 [ 4 ] ; size_t t2 ; (
void ) t3 ; out = t4 -> mA ; t1 [ 0ULL ] = 1.0 ; t1 [ 1ULL ] = 1.0 ; t1 [
2ULL ] = 1.0 ; t1 [ 3ULL ] = 1.0 ; for ( t2 = 0ULL ; t2 < 4ULL ; t2 ++ ) { t0
[ t2 ] = t1 [ t2 ] ; } out . mX [ 0 ] = t0 [ 0 ] ; out . mX [ 1 ] = t0 [ 1 ]
; out . mX [ 2 ] = t0 [ 2 ] ; out . mX [ 3 ] = t0 [ 3 ] ; out . mX [ 4 ] = -
0.24940476190476191 ; ( void ) sys ; ( void ) t4 ; return 0 ; } static
int32_T ds_a_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput *
t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2
-> mA_P ; out . mNumCol = 5ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 4 ; out . mJc [ 3 ] = 4 ; out . mJc [
4 ] = 4 ; out . mJc [ 5 ] = 5 ; out . mIr [ 0 ] = 1 ; out . mIr [ 1 ] = 2 ;
out . mIr [ 2 ] = 3 ; out . mIr [ 3 ] = 4 ; out . mIr [ 4 ] = 0 ; ( void )
...
= 1ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ;
out . mIr [ 0 ] = 4 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mC_P ; out . mNumCol = 1ULL ; out . mNumRow = 5ULL
...
5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ; out . mIr [ 0 ] = 4 ; (
void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_tdxf_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mTDXF_P ; out .
mNumCol = 5ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
= 0 ; out . mJc [ 2 ] = 4 ; out . mJc [ 3 ] = 4 ; out . mJc [ 4 ] = 4 ; out .
mJc [ 5 ] = 5 ; out . mIr [ 0 ] = 1 ; out . mIr [ 1 ] = 2 ; out . mIr [ 2 ] =
3 ; out . mIr [ 3 ] = 4 ; out . mIr [ 4 ] = 0 ; ( void ) sys ; ( void ) t2 ;
...
mNumCol = 0ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ; ( void ) sys ;
...
out . mX [ 4 ] = false ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
int32_T ds_slf ( const NeDynamicSystem * sys , const NeDynamicSystemInput *
t1 , NeDsMethodOutput * t2 ) { PmBoolVector out ; ( void ) t1 ; out = t2 ->
mSLF ; out . mX [ 0 ] = false ; out . mX [ 1 ] = false ; out . mX [ 2 ] =
false ; out . mX [ 3 ] = false ; out . mX [ 4 ] = false ; ( void ) sys ; (
...
mNumCol = 2ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
...
true ; out . mX [ 3 ] = true ; out . mX [ 4 ] = false ; ( void ) sys ; ( void
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mDXICR_P ; out . mNumCol = 5ULL ; out . mNumRow =
0ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out
. mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; ( void ) sys ;
...
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mICRM_P ; out . mNumCol = 5ULL ; out . mNumRow = 0ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [
4 ] = 0 ; out . mJc [ 5 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
mNumCol = 5ULL ; out . mNumRow = 0ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
= 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out .
mJc [ 5 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
...
out . mX [ 0 ] = 1.0 ; out . mX [ 1 ] = - 0.000838 ; out . mX [ 2 ] = 1.0 ;
out . mX [ 3 ] = 1.0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
int32_T ds_m_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput *
t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2
-> mM_P ; out . mNumCol = 5ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 2 ; out . mJc [ 3 ] = 3 ; out . mJc [
4 ] = 4 ; out . mJc [ 5 ] = 4 ; out . mIr [ 0 ] = 1 ; out . mIr [ 1 ] = 0 ;
out . mIr [ 2 ] = 2 ; out . mIr [ 3 ] = 3 ; ( void ) sys ; ( void ) t2 ;
...
mNumCol = 5ULL ; out . mNumRow = 4ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
= 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out .
mJc [ 5 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
...
4ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2
...
= 1.0E-9 ; out . mX [ 4 ] = 1.0E-9 ; ( void ) sys ; ( void ) t2 ; return 0 ;
...
1.0E-9 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_lv (
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmBoolVector out ; ( void ) t1 ; out = t2 -> mLV ;
out . mX [ 0 ] = false ; out . mX [ 1 ] = false ; out . mX [ 2 ] = false ;
out . mX [ 3 ] = false ; out . mX [ 4 ] = true ; ( void ) sys ; ( void ) t2 ;
return 0 ; } static int32_T ds_slv ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmBoolVector out ; (
void ) t1 ; out = t2 -> mSLV ; out . mX [ 0 ] = false ; out . mX [ 1 ] =
false ; out . mX [ 2 ] = false ; out . mX [ 3 ] = false ; out . mX [ 4 ] =
true ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_nldv (
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmBoolVector out ; ( void ) t1 ; out = t2 -> mNLDV
; out . mX [ 0 ] = false ; out . mX [ 1 ] = false ; out . mX [ 2 ] = false ;
out . mX [ 3 ] = false ; out . mX [ 4 ] = false ; ( void ) sys ; ( void ) t2
; return 0 ; } static int32_T ds_sclv ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmBoolVector out ; (
void ) t1 ; out = t2 -> mSCLV ; out . mX [ 0 ] = false ; out . mX [ 1 ] =
false ; out . mX [ 2 ] = false ; out . mX [ 3 ] = false ; out . mX [ 4 ] =
false ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_y ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmRealVector out ; real_T X_idx_1 ; real_T X_idx_4 ; X_idx_1 = t1 ->
mX . mX [ 1 ] ; X_idx_4 = t1 -> mX . mX [ 4 ] ; out = t2 -> mY ; out . mX [ 0
] = X_idx_1 ; out . mX [ 1 ] = - ( ( X_idx_1 * - 0.00376 - X_idx_4 *
0.24940476190476191 ) - X_idx_4 ) ; ( void ) sys ; ( void ) t2 ; return 0 ; }
static int32_T ds_dxy ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t5 , NeDsMethodOutput * t6 ) { PmRealVector out ; (
void ) t5 ; out = t6 -> mDXY ; out . mX [ 0 ] = 1.0 ; out . mX [ 1 ] =
0.00376 ; out . mX [ 2 ] = 1.2494047619047619 ; ( void ) sys ; ( void ) t6 ;
return 0 ; } static int32_T ds_dxy_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mDXY_P ; out . mNumCol = 5ULL ; out . mNumRow =
2ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 2 ; out
. mJc [ 3 ] = 2 ; out . mJc [ 4 ] = 2 ; out . mJc [ 5 ] = 3 ; out . mIr [ 0 ]
= 0 ; out . mIr [ 1 ] = 1 ; out . mIr [ 2 ] = 1 ; ( void ) sys ; ( void ) t2
; return 0 ; } static int32_T ds_duy ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void )
...
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mMDUY_P ; out . mNumCol = 1ULL ; out . mNumRow = 2ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
t2 -> mMDXY_P ; out . mNumCol = 5ULL ; out . mNumRow = 2ULL ; out . mJc [ 0 ]
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mTDXY_P ; out . mNumCol = 5ULL ; out . mNumRow =
2ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 2 ; out
. mJc [ 3 ] = 2 ; out . mJc [ 4 ] = 2 ; out . mJc [ 5 ] = 3 ; out . mIr [ 0 ]
= 0 ; out . mIr [ 1 ] = 1 ; out . mIr [ 2 ] = 1 ; ( void ) sys ; ( void ) t2
