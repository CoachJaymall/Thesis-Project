...
#endif
#include "nesl_rtw.h"
#include "ParallelTestBench_2ae6a85b_1.h"
...
sizeof ( outputparameters_init [ 0 ] ) ; } ParallelTestBench_2ae6a85b_1_dae (
& dae , & modelparams , & solverparams ) ; nesl_register_simulator_group (
"ParallelTestBench/TMotorU15/Solver Configuration_1" , 1 , & dae , &
