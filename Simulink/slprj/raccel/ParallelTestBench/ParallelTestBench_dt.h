...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . fdyvfxa4tp ) , 0 , 0 , 86 } ,
{ ( char_T * ) ( & rtB . bvn1smh1wj ) , 8 , 0 , 9 } , { ( char_T * ) ( & rtDW
. avkff5cs3v . LoggedData ) , 11 , 0 , 7 } , { ( char_T * ) ( & rtDW .
i3v3y1llki ) , 10 , 0 , 6 } , { ( char_T * ) ( & rtDW . kwqc3w5qsd ) , 8 , 0
, 32 } } ; static DataTypeTransitionTable rtBTransTable = { 5U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . BLDC_B ) , 0 , 0 , 2665 } , { ( char_T * ) ( & rtP .
R_maxIndex [ 0 ] ) , 7 , 0 , 16 } } ; static DataTypeTransitionTable
