 ...
 */
/* ParallelTestBench_59b138b3_1_ds.c - body for module ParallelTestBench_59b138b3_1_ds */
...
static NeEquationData s_equation_data[4] = { { "", 0U, 8,
    ...
    "ParallelTestBench/ICE Side Inertias/Ideal Rotational Motion Sensor", 1U, 0U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ParallelTestBench/ICE Side Inertias/Inertia", 2U, 1U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ParallelTestBench/ICE Side Inertias/Ideal Angular Velocity Source", 1U, 3U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ParallelTestBench/ICE Side Inertias/Rotational Friction", 1U, 4U, TRUE, 1.0,
    "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[4] = { { "ICE_Side_Inertias.Inertia.w", 0U,
    0, "ParallelTestBench/ICE Side Inertias/Inertia", 1.0, "1", 0.0, TRUE, FALSE,
    { { 1, 1 } }, NE_INIT_MODE_MANDATORY, "Rotational velocity", }, {
    ...
    "ICE_Side_Inertias.Inertia.t", 0U, 0,
    "ParallelTestBench/ICE Side Inertias/Inertia", 1.0, "1", 0.0, FALSE, FALSE,
      { { 1, 1 } }, NE_INIT_MODE_NONE, "Torque", }, {
    "ICE_Side_Inertias.Rotational_Friction.t", 0U, 0,
    "ParallelTestBench/ICE Side Inertias/Rotational Friction", 1.0, "1", 0.0,
    FALSE, FALSE, { { 1, 1 } }, NE_INIT_MODE_NONE, "Torque", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[34] = { {
    ...
    "\\u03B1", }, { "ICE_Side_Inertias.Ideal_Rotational_Motion_Sensor.phi",
    "ParallelTestBench/ICE Side Inertias/Ideal Rotational Motion Sensor", { { 1,
    ...
    "ICE_Side_Inertias.Ideal_Torque_Sensor.C.w",
    "ParallelTestBench/ICE Side Inertias/Ideal Torque Sensor", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Ideal_Torque_Sensor.R.w",
    "ParallelTestBench/ICE Side Inertias/Ideal Torque Sensor", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Ideal_Torque_Sensor.T",
    "ParallelTestBench/ICE Side Inertias/Ideal Torque Sensor", { { 1, 1 } },
    ...
    "ICE_Side_Inertias.Ideal_Torque_Sensor_T0",
    "ParallelTestBench/ICE Side Inertias/PS-Simulink\nConverter1", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Ideal_Torque_Sensor_T0", }, {
    "ICE_Side_Inertias.Inertia.I.w",
    "ParallelTestBench/ICE Side Inertias/Inertia", { { 1, 1 } }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Inertia.J.w",
    "ParallelTestBench/ICE Side Inertias/Inertia", { { 1, 1 } }, "rad/s", 1.0,
    "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Inertia.t", "ParallelTestBench/ICE Side Inertias/Inertia",
    { { 1, 1 } }, "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE,
    FALSE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "ICE_Side_Inertias.Inertia.w", "ParallelTestBench/ICE Side Inertias/Inertia",
    { { 1, 1 } }, "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED,
    NE_INIT_MODE_MANDATORY, FALSE, TRUE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE,
    "Rotational velocity", }, {
    "ICE_Side_Inertias.Mechanical_Rotational_Reference.W.w",
    "ParallelTestBench/ICE Side Inertias/Mechanical Rotational Reference", { { 1,
        1 } }, "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.PS_Terminator.I",
    ...
    "ICE_Side_Inertias.Rotational_Damper.C.w",
    "ParallelTestBench/ICE Side Inertias/Rotational Damper", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Rotational_Damper.R.w",
    "ParallelTestBench/ICE Side Inertias/Rotational Damper", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Rotational_Damper.t",
    "ParallelTestBench/ICE Side Inertias/Rotational Damper", { { 1, 1 } }, "N*m",
    1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "ICE_Side_Inertias.Rotational_Damper.w",
    "ParallelTestBench/ICE Side Inertias/Rotational Damper", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Rotational_Damper.power_dissipated",
    "ParallelTestBench/ICE Side Inertias/Rotational Damper", { { 1, 1 } },
    "kg*m^2/s^3", 1.0, "kg*m^2/s^3", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE,
    TRUE, FALSE, NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "ICE_Side_Inertias.Rotational_Friction.C.w",
    "ParallelTestBench/ICE Side Inertias/Rotational Friction", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Rotational_Friction.R.w",
    "ParallelTestBench/ICE Side Inertias/Rotational Friction", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Rotational_Friction.t",
    "ParallelTestBench/ICE Side Inertias/Rotational Friction", { { 1, 1 } },
    "N*m", 1.0, "N*m", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Torque", }, {
    "ICE_Side_Inertias.Rotational_Friction.w",
    "ParallelTestBench/ICE Side Inertias/Rotational Friction", { { 1, 1 } },
    "rad/s", 1.0, "1/s", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Rotational velocity", }, {
    "ICE_Side_Inertias.Rotational_Friction.power_dissipated",
    "ParallelTestBench/ICE Side Inertias/Rotational Friction", { { 1, 1 } },
    "J/s", 1.0, "J/s", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
...
static NeRange s_equation_range[5] = { {
    ...
    "C:/Program Files/MATLAB/R2023b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/friction.ssc",
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mLOG.mN = 26;
  out->mLOG.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 26);
  return out;
}
...
NeDynamicSystem *ParallelTestBench_59b138b3_1_dae_ds(PmAllocator *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  static SscIoInfo input_info[1];
  static SscIoInfo output_info[2];
  ...
  ds->mNumRealCache = 0;
  ds->mNumIntCache = 0;
  ds->mNumObservables = 34;
  ds->mNumObservableElements = 32;
  ds->mNumZcs = 0;
  ds->mNumAsserts = 0;
  ...
  input_info[0].mIdentifier = "ICE_Side_Inertias.Simulink_PS_Converter2_output0";
  ...
  input_info[0].mName = "ICE_Side_Inertias.Simulink_PS_Converter2_output0";
  input_info[0].mUnit = "rad/s";
  ds->mIo[SSC_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[SSC_OUTPUT_IO_TYPE] = 2;
  output_info[0].mIdentifier =
    "ICE_Side_Inertias.Ideal_Rotational_Motion_Sensor_W0";
  ...
  output_info[0].mName = "ICE_Side_Inertias.Ideal_Rotational_Motion_Sensor_W0";
  output_info[0].mUnit = "rad/s";
  output_info[1].mIdentifier = "ICE_Side_Inertias.Ideal_Torque_Sensor_T0";
  ...
  output_info[1].mName = "ICE_Side_Inertias.Ideal_Torque_Sensor_T0";
  ...
  ds->mMethods[NE_DS_METHOD_LOG] = ParallelTestBench_59b138b3_1_ds_log;
  ...
  ds->mMethods[NE_DS_METHOD_OBS_ACT] = ParallelTestBench_59b138b3_1_ds_obs_act;
  ds->mMakeOutput[NE_DS_METHOD_OBS_ACT] = ds_output_obs_act;
  ds->mMethods[NE_DS_METHOD_OBS_ALL] = ParallelTestBench_59b138b3_1_ds_obs_all;
                     ...
                     NeDsMethodOutput *t2)
{
  ...
  (void)t1;
  out = t2->mF;
  t0_idx_3 = -(0.0 * pmf_exp(-0.0) * 1.7795106867549253 + tanh(0.0) * 0.0005);
  out.mX[0] = -0.0;
  out.mX[1] = -0.0;
  out.mX[2] = 0.0;
  out.mX[3] = t0_idx_3;
...
static int32_T ds_a (const NeDynamicSystem *sys, const NeDynamicSystemInput *t4,
                     NeDsMethodOutput *t5)
{
  PmRealVector out;
  (void)t4;
